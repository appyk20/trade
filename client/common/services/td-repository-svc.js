 ...
 * This service has the key actions of trade.
 * It communicates with the server through $http to get the data
 *
 * @Methods Available:
 * - getUsers() | returns : a promise
 * - getUser(id) | returns: an object
 * - getInstruments() | returns : a promise
 * - getOrders() | returns : a promise
 * - deleteAllOrders()
 * - getLoggedInUser() | returns : an object
 * - setLoggedInUserById(id)
